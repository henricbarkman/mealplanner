            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "parent": {
                    "type": "string",
                    "description": "The parent page or data source where the new page is inserted, represented as a JSON object with a `page_id` or `data_source_id` key, and the corresponding ID.",
                    "format": "json"
                  },
                  "properties": {
                    "type": "string",
